...
fn addNixParserTargets(
    ...
    nix_test_runner.root_module.addImport("nix", module);
    ...
    nix_bench.root_module.addImport("nix", module);
    ...
    nix_bench_compare.root_module.addImport("nix", module);
    ...
    nix_bench_auto.root_module.addImport("nix", module);
...
fn addCclParserTargets(
    ...
    ccl_example.root_module.addImport("ccl", module);
